...
namespace Source\App\BtApi;

use Source\Core\Controller;
use Source\Models\Auth;
use Source\Models\BtDam\AppInvoice;
use Source\Models\BtDam\AppWallet;

/**
 * Class BtApi
 * @package Source\App\BtApi
 */
class BtApi extends Controller
{
     ...
     * @return BtApi
     */
    protected function call(int $code, string $type = null, string $message = null, string $rule = "errors"): BtApi
    {
     ...
     * @return BtApi
     */
    protected function back(array $response = null): BtApi
    {
        if (!empty($response)) {
